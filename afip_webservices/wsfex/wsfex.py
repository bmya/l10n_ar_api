...
class WsfexInvoiceDetails(object):
    ...
    def _set_details(self):
        ...
        self.detail.Cbte_nro = last_document_req.FEXResult_LastCMP.Cbte_nro + 1
        ...
        self.detail.Domicilio_cliente = self.invoice.customer_name
        self.detail.Moneda_Id = self.invoice.currency_id
        self.detail.Moneda_ctz = self.invoice.currency_cotization
    ...
    def _serialize_item(self, item):
        return self._get_item()(
            ...
            Pro_total_item=item.total_price,
...
class Wsfex(object):
    ...
    def _check_for_errors(request):
        if request.FEXErr.ErrMsg != 'OK':
            raise Exception("Error al realizar la consulta: "+str(request.FEXErr.ErrMsg)+"\n"
                            "Codigo de error N: "+str(request.FEXErr.ErrCode))
